...
import ${relativeProjectPath}.${joinTableName?lower_case}.entity.${joinTableName}Po;
</#if>
...
public abstract class Base${entity}Po extends Base${entity}CriteriaPo {
...
<#if table.code == reference.parentTable.code>
	...
	private List<${joinTableName}Po> list${joinTableName};
</#if>
<#if table.code == reference.childTable.code>
	<#assign join="inner"/>
	<#assign isJoin="true"/>
	...
	private ${joinTableName}Po ${joinTableName?uncap_first};
</#if>
</#list>
...
<#if table.code == reference.parentTable.code>
	...
	public List<${joinTableName}Po> getList${joinTableName}() {
		return list${joinTableName};
	}

	public void setList${joinTableName}(List<${joinTableName}Po> list${joinTableName}) {
...
<#if table.code == reference.childTable.code>
	...
	public ${joinTableName}Po get${joinTableName}() {
		return ${joinTableName?uncap_first};
	}

	public void set${joinTableName}(${joinTableName}Po ${joinTableName?uncap_first}) {
