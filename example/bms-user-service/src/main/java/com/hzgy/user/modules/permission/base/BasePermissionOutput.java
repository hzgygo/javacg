...
public abstract class BasePermissionOutput extends BaseOutput {
	...
	/**用户角色关系映射表**/
	private List<RolePermitRelationOutput> listRolePermitRelation;
	...
	public List<RolePermitRelationOutput> getListRolePermitRelation() {
		return listRolePermitRelation;
	}

	public void setListRolePermitRelation(List<RolePermitRelationOutput> listRolePermitRelation) {
