...
public interface IBaseUserService<Input extends BaseInput,Output extends BaseOutput> extends IService{
	...
	* @return ResultData<List<Output>>
	*/
	ResultData<List<Output>> listCriteriaLeftUserRoleRelation(Input input) throws BaseException;
	/**
	* 根据id串，in的方式关联查询数据
	* @param input input参数对象
	* @return ResultData<List<Output>>
	*/
	ResultData<List<Output>> listInIdsLeftUserRoleRelation(Input input) throws BaseException;
	/**
	* 关联查询所有数据
	* @return ResultData<List<Output>>
	*/
	ResultData<List<Output>> listAllLeftUserRoleRelation() throws BaseException;
	...
	* @return ResultData<Output>
	*/
	ResultData<Output> getOneByIdLeftUserRoleRelation(Long id) throws BaseException;
	...
	* @return ResultData<Output>
	*/
	ResultData<Output> getOneLeftUserRoleRelation(Input input) throws BaseException;
	...
	* @return ResultData<PageInfo<Output>>
	*/
	ResultData<PageInfo> listPaginatedLeftUserRoleRelation(Input input) throws BaseException;
    ...
    * @return ResultData<List<Output>>
    */
    ResultData<List<Output>> listCriteriaInnerOrganization(Input input) throws BaseException;
    /**
    * 根据id串，in的方式关联查询数据
    * @param input input参数对象
    * @return ResultData<List<Output>>
    */
    ResultData<List<Output>> listInIdsInnerOrganization(Input input) throws BaseException;
    /**
    * 关联查询所有数据
    * @return ResultData<List<Output>>
    */
    ResultData<List<Output>> listAllInnerOrganization() throws BaseException;
    ...
    * @return ResultData<Output>
    */
    ResultData<Output> getOneByIdInnerOrganization(Long id) throws BaseException;
    ...
    * @return ResultData<Output>
    */
    ResultData<Output> getOneInnerOrganization(Input input) throws BaseException;
    ...
    * @return ResultData<PageInfo<Output>>
    */
    ResultData<PageInfo> listPaginatedInnerOrganization(Input input) throws BaseException;
