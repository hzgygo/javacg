...
public abstract class BaseOrganizationPo extends BaseOrganizationCriteriaPo {
	...
	public List<UserPo> getListUser() {
		return listUser;
	}

	public void setListUser(List<UserPo> listUser) {
