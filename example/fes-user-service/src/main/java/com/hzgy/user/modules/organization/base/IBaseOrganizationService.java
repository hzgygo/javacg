...
public interface IBaseOrganizationService<Input extends BaseInput,Output extends BaseOutput> extends IService{
	...
	* @return ResultData<List<Output>>
	*/
	ResultData<List<Output>> listCriteriaLeftUser(Input input) throws BaseException;
	/**
	* 根据id串，in的方式关联查询数据
	* @param input input参数对象
	* @return ResultData<List<Output>>
	*/
	ResultData<List<Output>> listInIdsLeftUser(Input input) throws BaseException;
	/**
	* 关联查询所有数据
	* @return ResultData<List<Output>>
	*/
	ResultData<List<Output>> listAllLeftUser() throws BaseException;
	...
	* @return ResultData<Output>
	*/
	ResultData<Output> getOneByIdLeftUser(Long id) throws BaseException;
	...
	* @return ResultData<Output>
	*/
	ResultData<Output> getOneLeftUser(Input input) throws BaseException;
	...
	* @return ResultData<PageInfo<Output>>
	*/
	ResultData<PageInfo> listPaginatedLeftUser(Input input) throws BaseException;
